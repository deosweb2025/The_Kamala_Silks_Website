        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href={siteData.social.facebook} className="text-gray-300 hover:text-accent transition-colors" aria-label="Facebook">
              ...
              <a href={siteData.social.instagram} className="text-gray-300 hover:text-accent transition-colors" aria-label="Instagram">
